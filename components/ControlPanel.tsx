...
import { Play, Pause, Sparkles, Activity, Dna, ChevronUp, ChevronDown } from 'lucide-react';
...
export const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <div className="absolute top-4 right-4 w-80 md:w-96 flex flex-col gap-4 z-10 pointer-events-none">
      {/* Main Stats Card */}
      <div className="bg-slate-900/80 backdrop-blur-md border border-slate-700 p-4 rounded-xl shadow-2xl pointer-events-auto transition-all duration-300">
        ...
        {!isCollapsed && (
            <>
                <div className="flex items-center gap-3 text-xs text-slate-400 font-mono mt-2 mb-3">
                    <span className="flex items-center gap-1"><Activity size={12}/> {stats.fps} FPS</span>
